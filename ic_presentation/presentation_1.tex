...
\title[Breast Cancer Wisconsin]{Breast Cancer Wisconsin (Diagnostic)} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Luís Gustavo \\
Aramys Almeida Matos} % Your name
...
\item 1 variável de saída (maligno ou benigno)	
\item 357 benigno e 212 maligno
...
\item Identificar se é benigno ou maligno (-1 ou 1).
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.8\textwidth]{../img/corrcoef_range.png}
%    \label{fig:corrcoef}
%\end{figure}
%\end{frame}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../img/dist_zscore_out.png}
    \label{fig:corrcoef}
\end{figure}
\end{frame}
%------------------------------------------------
...
\begin{figure}[H]
\centering
  \includegraphics[width=.4\linewidth]{./Histogramas/Smoothness_Mean}
...
\begin{figure}[H]
\centering
  \includegraphics[width=.4\linewidth]{./Histogramas/Texture_Mean}
  %\captionof{figure}{Mean}
  \label{fig:test1}
\end{figure}%
...
\begin{block}{Função Discriminante}
...
\begin{itemize}
\item MLP apresenta baixo desempenho sem padronização
...
\end{block}
\item Maximizar a margem de separação
\end{itemize}
\end{frame}
